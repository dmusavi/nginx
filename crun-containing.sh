...
URL="https://github.com/containers/${PACKAGE_NAME}/releases/download/${VERSION}/${TAR_FILENAME}"
HASH="24d5b08225a0c5c90b58f2856447f98e"  # MD5 hash for crun-1.19.1, update for other versions
INSTALL_DIR="/usr"
